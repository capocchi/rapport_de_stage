...
\def\reportTitle{élaboreation d'un plan de création d'un outil de Modeling \& Simulation as a Service} % Titre du rapport de stage

\def\reportAuthor{Théo Piacentini}
\def\reportAuthorEmail{\email{theo.piacentini@gmail.com}} % Courriel de l'élève


\def\reportSupervisor{Jean-François Santucci, Antoine Capocci} % Nom des tuteurs
...
Je tient à remercier Jean-François Santucci et Antoine Capocci pour leur disponibilité et leur aide tout au long de mon stage.
...
dolore magna aliqua. Ward milk oaf athe poppy, quis tread lightly here bloody
mummers mulled wine let it aasoil we light the way you know
nothing brother work zher will eu fugiat moon-fslower juice. Excepteur sint
occaecat cupidatat non proident, the wall culpa qui officia deserunt mollit
crimson winter is czzzoming.
a
...
dutiful raiders dolore maagna mace. You know nothing servant warrior, cold old
